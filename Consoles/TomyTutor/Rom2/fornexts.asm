...
*      MOV  R3,R4             Destination pointer                         *TOMY*
...
*      CB   @CCBH63,@FAC2     If a string value                           *TOMY*
*      JL   BERR6             Its an error                                *TOMY*
       S    @C40,@VSPTR
...
ERRCDT B    @ERRSYN
NFOR2  LI   R0,FAC
       MOV  @FLT1,*R0+        Put a floating one in                       *TOMY*
       CLR  *R0+
       CLR  *R0+
       CLR  *R0
NFOR3  BL   @VPUSH            Push the step
       ...
       BL   @ASSG             Assign it
       A    @C8TOMY,@VSPTR    Restore to top of entry                     *TOMY*
...
*NFOR20 CI   R8,LN$*256       Line number token?                          *TOMY*
*      JNE  NFOR30            No, Check some more                         *TOMY*
*      INCT @PGMPTR           Skip the line number                        *TOMY*
*NFOR30 CI   R8,STRIN$*256    String?                                     *TOMY*
*      JNE  NFOR12            No, Check end of statement                  *TOMY*
*      BL   @PGMCHR           Yes, get string length                      *TOMY*
*      SWPB R8                Put the length in R8                        *TOMY*
*      A    R8,@PGMPTR        Skip that many length                       *TOMY*
*      CLR  R8                Clear next crunched code                    *TOMY*
NFOR20 EQU  $                                                             *TOMY*
...
*      S    @C4,@EXTRAM       Goto next line                              *TOMY*
...
NEXT4  S    @C24,@VSPTR       LOOP VARIABLES DON'T MATCH
       JMP  NEXT2
*NEXT2B BL   @VPUSH           Keep stack information                      *TOMY*
...
NEXT2  C    @VSPTR,@STVSPT    CHECK FOR BOTTOM OF STACK
       ...
       JNE  NEXT2A            Is not a 'FOR' entry, error                 *TOMY*
