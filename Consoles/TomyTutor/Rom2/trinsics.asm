...
* EXP$   EQU PAD0+>76
* OE$    EQU PAD0+>14
*EXC127 EQU  >B346                                                        *TOMY*
*FHALF EQU  >B34E                                                         *TOMY*
*SQRTEN EQU  >B356                                                        *TOMY*
*LOG10E EQU  >B35E                                                        *TOMY*
*LN10  EQU  >B366                                                         *TOMY*
*PI2   EQU  >B36E                                                         *TOMY*
*RPI2  EQU  >B376                                                         *TOMY*
*PI4   EQU  >B37E                                                         *TOMY*
*TANPI8 EQU  >B386                                                        *TOMY*
*TAN3P8 EQU  >B38E                                                        *TOMY*
*SQRP  EQU  >B396                                                         *TOMY*
*SQRQ  EQU  >B3AF                                                         *TOMY*
*FPOS1 EQU  >B3AF                                                         *TOMY*
*EXPP  EQU  >B3C0                                                         *TOMY*
...
* COMPUTE INTEGER POWER B^E
       ...
       ABS  @FAC              Absolute value of exponent                  *TOMY*
