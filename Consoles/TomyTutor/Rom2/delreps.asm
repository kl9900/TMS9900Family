...
*      MOV  @RAMTOP,R7        Check ERAM flag & get in reg                *TOMY*
*      JNE  DE01              ERAM, get from it                           *TOMY*
       BL   @GET1             Get line ptr from VDP
*      JMP  DE02                                                          *TOMY*
*DE01  BL   @GETG2            Get line ptr from ERAM                      *TOMY*
DE02   DEC  R1                Point to line length
       MOV  R1,R3             Prepare to read length
       MOV  R1,R9             Save copy for use later
*      MOV  R7,R7             Editing in ERAM?                            *TOMY*
*      JNE  DE03              ERAM, get length from it                    *TOMY*
       BL   @GETV1            Get line length from VDP
*      JMP  DE04                                                          *TOMY*
*DE03  MOVB *R3,R1                                                        *TOMY*
...
*      MOV  R7,R7             Editing in ERAM?                            *TOMY*
*      JNE  DE05              ERAM, read it as such                       *TOMY*
       BL   @GET1             Get line pointer from VDP
*      JMP  DE06                                                          *TOMY*
*DE05  BL   @GETG2            Get line pointer from ERAM                  *TOMY*
...
*      JMP  DEREB                                                         *TOMY*
*DE10  BL   @PUTG2            Put back into line # table                  *TOMY*
