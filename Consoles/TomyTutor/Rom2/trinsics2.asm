...
*************************************************************
*TAN$$ MOV  R11,R10                                                       *TOMY*
*      BL   @SAVRTN           Save return address                         *TOMY*
*      BL   @PUSH             Save FAC on stack                           *TOMY*
*      BL   @SIN$$            Compute SIN                                 *TOMY*
*      BL   @XTFAC$                                                       *TOMY*
*      BL   @COS$$            Compute COS                                 *TOMY*
*      BL   @POPSTK           Pop stack into ARG                          *TOMY*
*      CB   @FAC10,@CCBH7     Check for error                             *TOMY*
*      JEQ  PWRTN3            If error                                    *TOMY*
*      MOV  @FAC,R0           Is COS = zero?                              *TOMY*
*      JEQ  TAN01             Yes                                         *TOMY*
*      BL   @FDIV             No, TAN : = SIN(ARG)/COS(ARG)               *TOMY*
*PWRTN3 B    @ROLIN2                                                      *TOMY*
*TAN01 MOVB @ARG,@SIGN                                                    *TOMY*
*      BL   @OVEXP            Issue overflow message                      *TOMY*
*      JMP  PWRTN3            Clean up and exit                           *TOMY*
*************************************************************
...
*      A    @INTRIN,R3        Add in GROM offset               <<<<<<<<<< *TOMY*
*      MOVB R3,@GRMWAX(R13)    Write MSB of address                       *TOMY*
*      SWPB R3                Bare the LSB                                *TOMY*
*      MOVB R3,@GRMWAX(R13)    Write the LSB                              *TOMY*
*MOVRM4 MOVB *R13,*R0+        Read a byte                                 *TOMY*
       MOV  R3,R13                                                        *TOMY*
MOVRM4 MOVB *R13+,*R0+                                                    *TOMY*
...
CBH411 EQU  $                                                             *TOMY*
EXC127 BYTE >41,1,27,0,0,0,0,0          127                               *TOMY*
FHALF  BYTE >3F,50                      .5                                *TOMY*
ZER3   BYTE 0,0,0,0,0,0                                                   *TOMY*
SQRTEN BYTE >40,3,16,22,77,66,01,69     SQR(10)                           *TOMY*
LOG10E BYTE >3F,43,42,94,48,19,03,25    LOG10(E)                          *TOMY*
LN10   BYTE >40,2,30,25,85,09,29,94     LN(10)                            *TOMY*
CCBH7  EQU  $+3                                                           *TOMY*
PI2    BYTE >40,1,57,7,96,32,67,95      PI/2                              *TOMY*
RPI2   BYTE >3F,63,66,19,77,23,67,58    2/PI                              *TOMY*
PI4    BYTE >3F,78,53,98,16,33,97,45    PI/4                              *TOMY*
CBHA   EQU  $+7                                                           *TOMY*
CBH3F  EQU  $                                                             *TOMY*
TANPI8 BYTE >3F,41,42,13,56,23,73,10    TAN(PI/8)=SQR(2)-1                *TOMY*
TAN3P8 BYTE >40,2,41,42,13,56,23,73     TAN(3*PI/8)=SQR(2)+1              *TOMY*
**          SQR POLYNOMIALS  (HART SQRT 0231)
SQRP   BYTE >3F,58,81,22,90,00,00,00    P02=.58812 29E+00                 *TOMY*
       BYTE >3F,52,67,87,50,00,00,00    P01=.52678 75E+00                 *TOMY*
       BYTE >3E,58,81,20,00,00,00,00    P00=.58812 E-02                   *TOMY*
       BYTE SGNBIT                                                        *TOMY*
FLTONE EQU  $                                                             *TOMY*
FPOS1  EQU  $                                                             *TOMY*
SQRQ   BYTE >40,01,00,00,00,00,00,00    Q01=.1 E+01                       *TOMY*
       BYTE >3F,09,99,99,80,00,00,00    Q00=.99999 8 E-01                 *TOMY*
       BYTE SGNBIT                                                        *TOMY*
**          EXPPONENT POLYNOMIALS  (HART EXPD 1444)
**          P02 = .18312 36015 92753 84761 54 E+02
EXPP   BYTE >40,18,31,23,60,15,92,75                                      *TOMY*
**          P01 = .83140 67212 93711 03487 3446 E+03
       BYTE >41,08,31,40,67,21,29,37                                      *TOMY*
*           P00 = .51780 91991 51615 35743 91297 E+04
       BYTE >41,51,78,09,19,91,51,62                                      *TOMY*
       BYTE SGNBIT                                                        *TOMY*
**          Q03 = .1 E+01
EXPQ   BYTE >40,1,0,0,0,0,0,0                                             *TOMY*
**          Q02 = .15937 41523 60306 52437 552 E+03
       BYTE >41,01,59,37,41,52,36,03                                      *TOMY*
**          Q01 = .27093 16940 85158 99126 11636 E+04
       BYTE >41,27,09,31,69,40,85,16                                      *TOMY*
**          Q00 = .44976 33557 40578 41762 54723 E+04
       BYTE >41,44,97,63,35,57,40,58                                      *TOMY*
       BYTE SGNBIT                                                        *TOMY*
**          LOG POLYNOMIALS  (HART LOGE 2687)
**          P04 = .35670 51030 88437 69 E+00
LOGP   BYTE >3F,35,67,05,10,30,88,44                                      *TOMY*
**          P03 = -.11983 03331 36876 1464 E+02
       BYTE >BF,>F5,98,30,33,31,36,88                                     *TOMY*
**          P02 = .63775 48228 86166 05782 E+02
       BYTE >40,63,77,54,82,28,86,17                                      *TOMY*
**          P01 = -.10883 71223 55838 3228 E+03
       BYTE >BE,>FF,08,83,71,22,35,58                                     *TOMY*
**          P00 = .57947 38138 44442 78265 7 E+02
       BYTE >40,57,94,73,81,38,44,44                                      *TOMY*
       BYTE SGNBIT                                                        *TOMY*
LOGQ   EQU  $                                                             *TOMY*
**          Q04 = .1 E+01
       BYTE >40,01,0,0,0,0,0,0                                            *TOMY*
**          Q03 = -.13132 59772 88464 0339 E+02
       BYTE >BF,>F3,13,25,97,72,88,46                                     *TOMY*
**          Q02 = .47451 82236 02606 00365 E+02
       BYTE >40,47,45,18,22,36,02,61                                      *TOMY*
**          Q01 = -.64076 45807 52556 00596 E+02
       BYTE >BF,>C0,07,64,58,07,52,56                                     *TOMY*
**          Q00 = .28973 69069 22217 71601 9 E+02
       BYTE >40,28,97,36,90,69,22,22                                      *TOMY*
       BYTE SGNBIT                                                        *TOMY*
...
**          P07 = -.64473 16000 0 E-09
       BYTE >C4,>FA,44,73,16,00,00,00                                     *TOMY*
**          P06 = .56882 03332 688 E-07
CBH44  EQU  $+2                                                           *TOMY*
       BYTE >3C,05,68,82,03,33,26,88                                      *TOMY*
**          P05 = -.35988 09117 03133 E-05
       BYTE >C2,>FD,59,88,09,11,70,31                                     *TOMY*
**          P04 = .16044 11684 69828 31 E-03
       BYTE >3E,01,60,44,11,68,46,98                                      *TOMY*
**          P03 = -.46817 54131 06023 168 E-02
       BYTE >C1,>D2,81,75,41,31,06,02                                     *TOMY*
**          P02 = .79692 62624 56180 0806 E-01
       BYTE >3F,07,96,92,62,62,45,62                                      *TOMY*
**          P01 = -.64596 40975 06219 07082 E+00
       BYTE >C0,>C0,59,64,09,75,06,22                                     *TOMY*
**          P00 = .15707 96323 79489 63959 E+01
       BYTE >40,01,57,07,96,32,67,95                                      *TOMY*
       BYTE SGNBIT                                                        *TOMY*
**          ATN POLYNOMIAL  (HART ARCTN 4967)
ATNP   EQU  $                                                             *TOMY*
**          P09 = -.25357 18798 82 E-01
       BYTE >C0,>FE,53,57,18,79,88,20                                     *TOMY*
**          P08 = .50279 13843 885 E-01
       BYTE >3F,05,02,79,13,84,38,85                                      *TOMY*
**          P07 = -.65069 99940 1396 E-01
       BYTE >C0,>FA,50,69,99,94,01,40                                     *TOMY*
**          P06 = .76737 12439 1641 E-01
       BYTE >3F,07,67,37,12,43,91,64                                      *TOMY*
**          P05 = -.90895 47919 67196 E-01
       BYTE >C0,>F7,08,95,47,91,96,72                                     *TOMY*
**          P04 = .11111 04992 50526 62 E+00
       BYTE >3F,11,11,10,49,92,50,53                                      *TOMY*
**          P03 = -.14285 71269 75961 157 E+00
       BYTE >C0,>F2,28,57,12,69,75,96                                     *TOMY*
**          P02 = .19999 99997 89961 5228 E+00
       BYTE >3F,19,99,99,99,97,89,96                                      *TOMY*
**          P01 = -.33333 33333 32253 4275 E+00
       BYTE >C0,>DF,33,33,33,33,32,25                                     *TOMY*
